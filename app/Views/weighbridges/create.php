...
<h1 class="text-3xl font-bold mb-6 text-app-gray-800">Enregistrer un nouveau passage au Pont Bascule</h1>
...
<div class="bg-white shadow-md rounded-lg p-6 max-w-4xl mx-auto">
    ...
    <form action="<?php echo BASE_URL; ?>/weighbridges/create" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="text" id="weigh_number" name="weigh_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div>
                <label for="weigh_date" class="block text-app-gray-700 text-sm font-bold mb-2">Date de la pesée:</label>
                <input type="date" id="weigh_date" name="weigh_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="vehicle_number" name="vehicle_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div>
                <label for="driver_name" class="block text-app-gray-700 text-sm font-bold mb-2">Nom du chauffeur:</label>
                <input type="text" id="driver_name" name="driver_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div>
                <label for="first_weight" class="block text-app-gray-700 text-sm font-bold mb-2">Premier Poids (kg):</label>
                <input type="number" step="0.01" id="first_weight" name="first_weight" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0.01">
            </div>
            <div>
                <label for="second_weight" class="block text-app-gray-700 text-sm font-bold mb-2">Deuxième Poids (kg):</label>
                <input type="number" step="0.01" id="second_weight" name="second_weight" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0.01">
            </div>
            <div>
                <label for="net_weight_display" class="block text-app-gray-700 text-sm font-bold mb-2">Poids Net (kg):</label>
                <input type="text" id="net_weight_display" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 bg-app-gray-100 leading-tight focus:outline-none focus:shadow-outline" readonly>
            </div>
            <div class="md:col-span-2">
                <label for="notes" class="block text-app-gray-700 text-sm font-bold mb-2">Notes:</label>
                <textarea id="notes" name="notes" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
        </div>
        ...
        <div id="taxes-container">
            <div class="tax-item border border-app-gray-300 p-4 mb-4 rounded-md">
                <h3 class="font-bold text-app-gray-800 mb-2">Taxe #1</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-app-gray-700 text-sm font-bold mb-1">Description de la taxe:</label>
                        <input type="text" name="taxes[0][tax_description]" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
                    <div>
                        <label class="block text-app-gray-700 text-sm font-bold mb-1">Montant de la taxe (XAF):</label>
                        <input type="number" step="0.01" name="taxes[0][tax_amount]" class="shadow appearance-none border rounded w-full py-2 px-3 text-app-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0">
                    </div>
                </div>
...
<script>
    let taxIndex = 1; // Start from 1 as 0 is hardcoded
    ...
    document.addEventListener('DOMContentLoaded', calculateNetWeight); // Calculate on load
